...
import com.andhika185.lexica.view.LexicaView;
...
public class GameActivity extends AppCompatActivity implements Synchronizer.Finalizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            switch (action) {
                case "com.andhika185.lexica.action.RESTORE_GAME":
                    restoreGame();
                    break;
                case "com.andhika185.lexica.action.NEW_GAME":
    ...
    private void showScore(Bundle bundleWithSavedGame) {
        Intent scoreIntent = new Intent("com.andhika185.lexica.action.SCORE");
